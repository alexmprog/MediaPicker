...
public class VideoPicker {
    ...
    private VideoPickerOption selectedOption;
    ...
    private void selectImage(@NonNull final Activity activity, @NonNull final Callback callback) {
        final CharSequence[] items = VideoPickerOption.getOptionItems();
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                selectedOption = VideoPickerOption.getImageOption(items[item].toString());
                if (selectedOption == VideoPickerOption.CAMERA) {
                    if (result) {
                        callback.openCamera();
                    }
                } else if (selectedOption == VideoPickerOption.GALLERY) {
                    if (result) {
